...
- **Game Engine:** GameMaker Studio 2.3  
...
|---------|-------------|-------------|
| **Walls** | Blocks player movement and restricts access based on shape. | img.png |
| **Spikes** | Kill individual player cells to simplify the mass. | img.png |
| **Holes** | The mass can pass over if at least one cell remains on solid ground. Entirely over = death. | img.png |
| **Fruit** | Consumed to spawn a new cell on the opposite end of the mass. | img.png |
...
| Mechanic | Description | Image |
|---------|-------------|-------------|
| **Independence** | Separated masses move in sync but interact independently. They can recombine. | img.png |
| **Set Spikes** | Become regular spike traps after first contact. | img.png |
